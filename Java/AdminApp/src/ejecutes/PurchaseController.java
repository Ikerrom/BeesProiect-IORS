...
public class PurchaseController implements ActionListener {
     ...
     */
    public PurchaseController(Model model, ViewBuys viewBuys) {
        this.model = model;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (actionCommand) {
            case "Add":
                ...
                PurchaseController controller = new PurchaseController (model2, view2);
                break;
            case "Delete":
                if(viewBuys.jTable1.getSelectedRow()!=-1){
                    ...
                    PurchaseController controller1 = new PurchaseController (model1, view1);
                    break;
                }else{
