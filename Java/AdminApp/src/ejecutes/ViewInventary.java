...
public class ViewInventary extends javax.swing.JFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        // TODO add your handling code here:
        int idpro =(int) jTable1.getValueAt(jTable1.getSelectedRow(), 0);
        String name = (String) jTable1.getValueAt(jTable1.getSelectedRow(), 2);
        int amount = (int) jTable1.getValueAt(jTable1.getSelectedRow(), 3);

        jTextField1.setText(String.valueOf(idpro));
