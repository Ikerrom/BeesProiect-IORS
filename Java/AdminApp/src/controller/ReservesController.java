    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (actionCommand) {
            ...
            case "Delete":
                ...
                LocalDate dia_reservado1 = LocalDate.parse(viewReserves.jTextField3.getText());
                int lata1 = Integer.valueOf(viewReserves.jComboBox2.getSelectedItem().toString()); 
                LocalDate dia_dereserva1 = LocalDate.parse(viewReserves.jTextField4.getText());
                if(viewReserves.jTable1.getSelectedRow()!=-1){
                    Reserve r1=new Reserve(dni1,String.valueOf(dia_reservado1),lata1,String.valueOf(dia_dereserva1));
